...
CREATE TABLE `server_config` (
	...
	`antispam_voice_switching` BOOLEAN NOT NULL DEFAULT '0',
	...
	`voice_channelid` BIGINT UNSIGNED NOT NULL DEFAULT '0',
	...
	`embed_voicechannel` BOOLEAN NOT NULL DEFAULT '0',
	`embed_activitychannel` BOOLEAN NOT NULL DEFAULT '0',
	`embed_logchannel` BOOLEAN NOT NULL DEFAULT '0',
	`embed_modchannel` BOOLEAN NOT NULL DEFAULT '0',
	`color_voicechannel` INT UNSIGNED NOT NULL DEFAULT '65280',
	`color_activitychannel` INT UNSIGNED NOT NULL DEFAULT '65535',
	`color_logchannel` INT UNSIGNED NOT NULL DEFAULT '255',
	`color_modchannel` INT UNSIGNED NOT NULL DEFAULT '16611680',
	`color_logmessages` INT UNSIGNED NOT NULL DEFAULT '16776960',
	...
	`log_message_join` TEXT NULL,
	`log_message_leave` TEXT NULL,
